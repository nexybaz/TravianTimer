-- ============================================================
-- Migration 016: Fix Push Trigger — net.http_post statt extensions.http_post
-- ============================================================
-- pg_net Extension liegt im Schema "net", nicht "extensions".
-- Die Funktion heisst net.http_post(url, body, params, headers, timeout_milliseconds).
-- ============================================================
