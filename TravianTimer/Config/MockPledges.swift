...
enum MockPledges {
    ...
    static func forCall(_ call: CallItem) -> [TroopPledge] {
        ...
        return [
            ...
            TroopPledge(playerName: "ShadowBlade", villageName: "Germanen HQ",
            ...
            TroopPledge(playerName: "RomanaX", villageName: "Roma Prima",
                        villageX: 5, villageY: -10,
                        troopKind: "romans.praetorian", count: 120, pledgedAt: now),
            TroopPledge(playerName: "RomanaX", villageName: "Roma Secunda",
